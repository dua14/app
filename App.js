...
import { Text, View, StyleSheet,Image ,ScrollView,TouchableOpacity,textwithoutencoding} from 'react-native';
...
>
<TouchableOpacity
onPress={() => Communications.textWithoutEncoding(' ','May all your dreams and wishes come true')}
style = {{
 width: 300,
  height : 100,
  flex : 1,
...
>
<TouchableOpacity
onPress={() =>  Communications.textWithoutEncoding(' ','Hope your special day bring you all that your heart desires!...')}
style = {{
 width: 300,
  height : 100,
  flex : 1,
...
<View>
<TouchableOpacity
onPress={() =>  Communications.textWithoutEncoding(' ','Wishing you and yours a very blessed and happy new year ')}
style = {{
 width: 300,
  height : 100,
  flex : 1,
...
>
<TouchableOpacity
onPress={() =>  Communications.textWithoutEncoding(' ','Everything that is new brings hope. May your hope be renewed in the coming new year. Happy New Year!')}
style = {{
 width: 300,
  height : 110,
  flex : 1,
